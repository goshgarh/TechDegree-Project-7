...
//q1=document.querySelector('#qwerty');
...
var phrases = [ 'My favorite movie', 'This is the end', 'What do you want to be', "He never knew that awesome trick", "Never ever give up", "I wish Treehouse had better support channel"];
      ...
      var shows= document.querySelectorAll('.show');
       if (letters.length===shows.length) { 
           ...
           h.style.display='block';
                            ...
                            h.style.display='block';
//                           setTimeout(function f() { location.reload()},3000);
                           }
    }
checkWin();
q.addEventListener('click', (event) => {  
   if(event.target.nodeName==='BUTTON') 
    // or you can use tagName instead of nodeName
